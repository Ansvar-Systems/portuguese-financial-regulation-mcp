...
[![npm version](https://badge.fury.io/js/%40ansvar%2Fportuguese-financial-regulation-mcp.svg)](https://www.npmjs.com/package/@ansvar/portuguese-financial-regulation-mcp)
...
**Endpoint:** `https://mcp.ansvar.eu/portuguese-financial-regulation/mcp`

| Client | How to Connect |
|--------|---------------|
| **Claude.ai** | Settings > Connectors > Add Integration > paste URL |
| **Claude Code** | `claude mcp add portuguese-financial-regulation-mcp --transport http https://mcp.ansvar.eu/portuguese-financial-regulation/mcp` |
...
```json
{
  "mcpServers": {
    "portuguese-financial-regulation-mcp": {
      "type": "url",
      "url": "https://mcp.ansvar.eu/portuguese-financial-regulation/mcp"
    }
  }
}
```
...
```bash
npx @ansvar/portuguese-financial-regulation-mcp
```
...
```json
{
  "mcpServers": {
    "portuguese-financial-regulation-mcp": {
      "command": "npx",
      "args": ["-y", "@ansvar/portuguese-financial-regulation-mcp"]
    }
  }
}
```
