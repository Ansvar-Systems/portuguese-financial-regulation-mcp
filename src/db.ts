/**
 * SQLite database access layer for the Portuguese Financial Regulation MCP server.
 *
 * Schema mirrors the Portuguese regulatory structure:
 *   - sourcebooks        — top-level document categories (CMVM_Regulamentos, CMVM_Instrucoes, BDP_Avisos, ASF_Normas)
 *   - provisions         — individual articles from CMVM, Banco de Portugal, and ASF instruments
 *   - enforcement_actions — regulatory enforcement decisions and penalties
 *
