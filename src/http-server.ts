...
const TOOLS = [
  {
    ...
    description:
      "Pesquisa de texto integral em regulamentos CMVM, avisos do Banco de Portugal e normas da ASF. (Full-text search across CMVM, Banco de Portugal, and ASF provisions.)",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Termo de pesquisa" },
        sourcebook: { type: "string", description: "Filtrar por sourcebook (ex.: CMVM_REGULAMENTOS, BDP_AVISOS). Optional." },
        status: {
          type: "string",
          enum: ["in_force", "deleted", "not_yet_in_force"],
          description: "Filtrar por estado. Optional.",
        },
  ...
  },
  {
    ...
    description: "Obtém uma disposição específica pelo sourcebook e referência.",
    inputSchema: {
      type: "object" as const,
      properties: {
        sourcebook: { type: "string", description: "Identificador do sourcebook (ex.: CMVM_REGULAMENTOS, BDP_AVISOS)" },
        reference: { type: "string", description: "Referência da disposição" },
      },
  ...
  },
  {
    ...
    description: "Lista todos os sourcebooks disponíveis com nomes e descrições.",
    inputSchema: { type: "object" as const, properties: {}, required: [] },
  },
  {
    name: "pt_fin_search_enforcement",
    description: "Pesquisa de decisões de supervisão — coimas, suspensões e advertências da CMVM, BdP e ASF.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: { type: "string", description: "Termo de pesquisa (nome da entidade, tipo de infracção, etc.)" },
        action_type: {
          type: "string",
  ...
  },
  {
    ...
    description: "Verifica se uma referência específica está actualmente em vigor.",
    inputSchema: {
      type: "object" as const,
      properties: {
        reference: { type: "string", description: "Referência da disposição a verificar" },
      },
      required: ["reference"],
    },
  },
